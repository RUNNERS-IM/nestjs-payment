...
export class initial1653884696900 implements MigrationInterface {
    name = 'initial1653884696900'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cards" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" character varying NOT NULL, "customer_uid" character varying, "card_number" character varying NOT NULL, "expiry_year" integer NOT NULL, "expiry_month" integer NOT NULL, "expiry" character varying, "birth" character varying, "pwd2digit" character varying NOT NULL, "cvc" character varying NOT NULL, "last_card_number" character varying, "pg_id" character varying, "pg_provider" character varying, "userId" uuid, CONSTRAINT "REL_7b7230897ecdeb7d6b0576d907" UNIQUE ("userId"), CONSTRAINT "PK_5f3269634705fdff4a9935860fc" PRIMARY KEY ("id"))`);
